odoo.define('point_of_sale.RequireCreditButton', function(require) {
    'use strict';
    ...
    class RequireCreditButton extends PosComponent {
        setup() {
            super.setup();
    ...
    RequireCreditButton.template = 'RequireCreditButton';

    ProductScreen.addControlButton({
        component: RequireCreditButton,
    });

    Registries.Component.add(RequireCreditButton);

    return RequireCreditButton;
});
